    ...
    return (
        <View style={signInStyles.container}>
            ...
            >
                ...
                <Text style={signInStyles.text_footer}>Username</Text>
                ...
                {/* Email Field */}
                <Text style={[signInStyles.text_footer, {marginTop: 35}]}>Email</Text>
                <View style={signInStyles.action}>
                    <FontAwesome
                        name='user-o'
                        color="black"
                ...
                {/* Confirm password */}
                <Text style={[signInStyles.text_footer, {marginTop: 35}]}>Confirm Password</Text>
                <View style={signInStyles.action}>
                    <FontAwesome
                        name='lock'
                        color="black"
                ...
                <View style={signInStyles.button}>
                    ...
                    onPress={() => navigation.navigate("GuideNavigator")}
